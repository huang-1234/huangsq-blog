## 20210606 好奇标识浏览器身份的User-Agent(2021.6.6)

**在解释 “为什么每个浏览器的 User-Agent 都有 Mozilla 字样？” 之前先贴一段目前常见的浏览器 User-Agent 。**
