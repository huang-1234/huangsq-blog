...
2. 使用flexbox解决方案
3. 使用百分比加媒体查询
4. 使用[rem](http://caibaojian.com/t/rem)
...
第一步，视觉设计阶段，设计师按宽度750px（[iphone](http://caibaojian.com/t/iphone) 6）做设计稿，除图片外所有设计元素用矢量路径来做。设计定稿后在750px的设计稿上做标注，输出标注图。同时等比放大1.5倍生成宽度1125px的设计稿，在1125px的稿子里切图。
...
这篇文章对我来说价值也很大，今后做[html5](http://caibaojian.com/t/html5)的项目就有思路了，本文提到的三种方法将来肯定都有用武之地。

[原文]([移动前端自适应适配布局解决方案 - Charliexie - 博客园 (cnblogs.com)](https://www.cnblogs.com/Charliexie/p/6900640.html))
