...
[此文章为某算法博主的博客](http://blog.codinglabs.org/)
...
<font color=red>一般来说，主成分分析(Principal Components Analysis, PCA)适用于数据的线性降维。而核主成分分析(Kernel PCA, KPCA)可实现数据的非线性降维，用于处理线性不可分的数据集。</font>
