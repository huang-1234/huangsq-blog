...
-  请求与响应<font color=red>支持 HTTP 头，增加了状态码，响应对象的一开始是一个响应状态行</font>
-  协议版本信息需要随着请求一起发送，<font color=red>支持 HEAD，POST 方法</font>
-  支持<font color=red>传输 HTML 文件以外其他类型的内容</font>
